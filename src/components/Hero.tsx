        ...
        >
            ...
            >
                ...
                <div className="absolute inset-0 z-10 opacity-10">
                    ...
                    <div className="absolute bottom-32 left-32 w-48 h-48 border-2 border-white rounded-full" />
            ...
            <div className="container relative z-20 px-4 py-32">
                <div className="max-w-5xl mx-auto">
                    ...
                    >
                        {/* Subtitle */}
                        <div className="mb-6">
                            <span className="inline-block px-4 py-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full text-white/90 text-sm font-medium tracking-wide">
                        ...
                        {/* Tagline */}
                        <p className="text-2xl md:text-3xl font-light mb-6 text-white/95 max-w-3xl mx-auto leading-relaxed">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
                            <Button
                                size="lg"
                                className="bg-accent-yellow text-brand-dark hover:bg-brand hover:text-white text-lg px-10 py-7 rounded-full transition-all hover:scale-105 font-bold shadow-2xl"
                            ...
                            <Button
                                size="lg"
                                variant="outline"
                                className="border-2 border-white text-white hover:bg-white hover:text-brand text-lg px-10 py-7 rounded-full transition-all font-semibold"
