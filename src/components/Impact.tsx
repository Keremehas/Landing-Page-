    ...
    return (
        <section id="impact" className="py-24 md:py-32 bg-white relative overflow-hidden">
            ...
            <div className="absolute inset-0 opacity-5">
                ...
                <div className="absolute bottom-20 right-20 w-48 h-48 border-2 border-accent-yellow rounded-full" />
                <div className="absolute top-1/2 right-1/4 w-24 h-24 border-2 border-brand-soft rotate-45" />
            </div>
            ...
            <div className="container mx-auto px-4 md:px-6 relative">
                            ...
                            <Card className="text-center h-full hover:shadow-2xl transition-all duration-300 border-none shadow-lg bg-surface group overflow-hidden relative">
                                ...
                                <CardHeader className="flex flex-col items-center pb-4 relative">
                                    ...
                                    <div className="relative mb-4">
                                        <div className="absolute inset-0 bg-gradient-to-br from-brand/20 to-brand-soft/20 rounded-full blur-xl" />
                                        <div className={`relative bg-white p-4 rounded-full shadow-md ${stat.color}`}>
                                            <stat.icon className="w-10 h-10" strokeWidth={1.5} />
                                        </div>
                                    </div>

                                    {/* Value */}
                                    <CardTitle className="text-5xl font-bold bg-gradient-to-br from-brand to-brand-soft bg-clip-text text-transparent mb-2">
                                        {stat.value}
                                    </CardTitle>
                                ...
                                {/* Bottom Accent */}
                                <div className={`h-1 bg-gradient-to-r from-transparent via-current to-transparent ${stat.color} opacity-50`} />
                            </Card>
                        </motion.div>
                    ))}
                </div>
                ...
                >
                    <div className="bg-gradient-to-r from-brand-dark via-brand to-brand-soft p-8 rounded-2xl shadow-xl">
